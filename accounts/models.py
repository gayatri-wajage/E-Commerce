...
class Profile(BaseModel):
    ...
    is_emali_verified = models.BooleanField(default=False)
    ...
    def get_cart_count(self):
        ...
        # if cart:
        #     return cart.cart_items.count()  # Return the count of items in the cart
...
def create_cart_for_new_user(sender, instance, created, **kwargs):
    if created:
        # Ensure a cart is created for new users
